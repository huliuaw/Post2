...
<body>
    ...
    <div class="bg-dark py-3">
        <div class="container">
            <div class="h4 text-white">생성</div>
        </div>
    </div>
            ...
            <div class="card border-0 shadow-lg">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="address" id="address" cols="30" rows="4" placeholder="Enter Address" required minlength="4" class="form-control">{{ old('address') }}</textarea>
